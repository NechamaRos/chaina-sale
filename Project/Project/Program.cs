...
//builder.Services.AddDbContext<Context>(c => c.UseSqlServer("Data Source=srv2\\pupils;Initial Catalog=N&T_Project;Integrated Security=True;Trust Server Certificate=True;"));
